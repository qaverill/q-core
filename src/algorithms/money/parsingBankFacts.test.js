...
const unneededMvcuOldFields = { account: null, balance: null, type: null, blaah: null };
  ...
  describe('parseCiti()', () => {
    it('parses payments correctly', () => {
      expect(parseCiti([
        ...
        { timestamp: 1614574800, amount: 25.00, description: 'mock citi payment', account: 'citi' },
      ]);
    });
    it('parses returns correctly', async () => {
      expect(parseCiti([
        ...
        { timestamp: 1603080000, amount: -49.50, description: 'GUIDEBOAT/TERRITORY AH 855-8720868 OH', account: 'citi' },
      ]);
    });
    it('ignores credit card bill payments', () => {
      expect(parseCiti([
        ...
        { timestamp: 1604293200, amount: -1848.87, description: 'ONLINE PAYMENT, THANK YOU', account: 'citi' },
      ]);
    });
  });
  describe('parseMvcu()', () => {
  ...
  describe('parseMvcuOld()', () => {
    it('parses payments correctly', () => {
      expect(parseMvcuOld([
        ...
        { timestamp: 1599019200, amount: -115.00, description: 'mvcu_old payment', account: 'mvcu_old' },
      ]);
    });
    it('parses income correctly', () => {
      expect(parseMvcuOld([
        ...
        { timestamp: 1598846400, amount: 1.77, description: 'mvcu_old income', account: 'mvcu_old' },
      ]);
    });
  });
  describe('parseVenmo()', () => {
