...
import { q_colors, q_styledComponents, q_utils } from 'q-lib';

const { red } = q_colors;
const { PopupContainer, TextInput, Button } = q_styledComponents;
        ...
        this.updateDataQUnsaved(parent.state.unsaved
          .map((t, i) => {
            ...
            if (i === idx) {
              ...
              updatedTransaction.amount = q_utils.roundToTwoDecimalPlaces(transaction.amount + updatedTransaction.amount);
            }
